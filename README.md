...
Tested with Windows 10,11. Go to [Nice Tabs v0.4.0-alpha](https://github.com/andrewschalk/Nice-Tabs/releases/tag/v0.4.0-alpha) and download NiceTabs.exe. Windows may suggest the program is a virus, I can assure you it's not, just hit "more info" and "run anyway". Nice Tabs will take a long time to open as it unpacks temporary files, this is a work in progress.
